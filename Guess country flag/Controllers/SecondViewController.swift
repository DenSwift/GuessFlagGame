...
class SecondViewController: UIViewController {
    ...
    // Storage
    var countryStorage: [String: UIImage] = [:]
    ...
    override func viewDidLoad() {
        ...
        countryStorage = ["Турция": UIImage(named: "turkey")!, "Канада": UIImage(named: "kanada")!, "США": UIImage(named: "usa")!, "Испания": UIImage(named: "spain")!,"Польша": UIImage(named: "poland")!, "Марокко": UIImage(named: "morroco")!, "Болгария": UIImage(named: "bulgary")!, "Швеция": UIImage(named: "sweden")!,"Румыния": UIImage(named: "romania")!, "Алжир": UIImage(named: "algeria")!, "Швейцария": UIImage(named: "switzerland")!, "Swift": UIImage(named: "swift")!]
        countryStorage1 = ["Турция": UIImage(named: "turkey")!, "Канада": UIImage(named: "kanada")!, "США": UIImage(named: "usa")!]
        countryStorage2 = ["Польша": UIImage(named: "poland")!, "Марокко": UIImage(named: "morroco")!, "Болгария": UIImage(named: "bulgary")!]
        countryStorage3 = ["Румыния": UIImage(named: "romania")!, "Алжир": UIImage(named: "algeria")!, "Швейцария": UIImage(named: "switzerland")!]
        countryStorage4 = ["Swift": UIImage(named: "swift")!, "Швеция": UIImage(named: "sweden")!, "Испания": UIImage(named: "spain")!]
    ...
    private func checkAnswer(sender: UIImageView) {
        ...
        if questionLabel.text == "Swift" {
            let usaImage = UIImage(named: "swift")
            ...
            let usaImage = UIImage(named: "switzerland")
            if sender.image == usaImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
            ...
            let usaImage = UIImage(named: "morroco")
            if sender.image == usaImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
            ...
            let usaImage = UIImage(named: "romania")
            if sender.image == usaImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
        ...
        } else if  questionLabel.text == "Алжир" {
            let usaImage = UIImage(named: "algeria")
            if sender.image == usaImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
            ...
            let usaImage = UIImage(named: "sweden")
            if sender.image == usaImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
            ...
            let usaImage = UIImage(named: "bulgary")
            if sender.image == usaImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
            ...
            let usaImage = UIImage(named: "spain")
            if sender.image == usaImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
            ...
            let usaImage = UIImage(named: "poland")
            if sender.image == usaImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
            ...
            let turkeyImage = UIImage(named: "turkey")
            if sender.image == turkeyImage {
                correctAnswer()
                downloadImage(sender1: firstFlagImage, sender2: secondFlagImage, sender3: thirdFlagImage, sender4: fourthFlagImage)
                downloadName(sender: questionLabel)
            } else {
    ...
    private func downloadName(sender: UILabel) {
       // sender.text = countryStorage.keys.randomElement()
        ...
        if firstFlagImage.image == turkeyImage {
            firstStorage.append("Турция")
        ...
        let morrocoImage = UIImage(named: "morroco")
        let bulgaryImage = UIImage(named: "bulgary")
        
        if secondFlagImage.image == polandImage {
            secondStorage.append("Польша")
        } else if secondFlagImage.image == morrocoImage {
        ...
        let algeriaImage = UIImage(named: "algeria")
        let switzerlandImage = UIImage(named: "switzerland")
        
        if thirdFlagImage.image == romaniaImage {
            thirdStorage.append("Румыния")
        } else if thirdFlagImage.image == algeriaImage {
            thirdStorage.append("Алжир")
        } else if thirdFlagImage.image == switzerlandImage {
            thirdStorage.append("Швейцария")
        }
        ...
        if fourthFlagImage.image == swiftImage {
            fourthStorage.append("Swift")
        } else if fourthFlagImage.image == swedenImage {
            fourthStorage.append("Швеция")
        } else if fourthFlagImage.image == spainImage {
